...
//});
//
//// Our Wine model representation...
//App.Wine = DS.Model.extend({
//    name: DS.attr('string'),
//    year: DS.attr('string'),
//    grapes: DS.attr('string'),
//    country: DS.attr('string'),
//    region: DS.attr('string'),
//    description: DS.attr('string'),
//    picture: DS.attr('string'),
//    // Use a computed property to add the pics path or set the generic for picture
//    newPicture: function() {
...
// Local Data Store using Ember Data - FixtureAdapter
// -- could also use an Ember Data RESTAdapter to communicate with REST API's alternatively
//App.Wine.FIXTURES = [
//    {
//        id: 1,
